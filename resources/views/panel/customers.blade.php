                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class=" mb-0" style="font-family: 'Cairo', sans-serif">العملاء</h4>
                            </div><!-- end card header -->
                                ...
                                <div class="listjs-table" id="customerList">
                                    <div class="row g-4 mb-3">
                                        <div class="col-sm-auto">
                                            <div>
                                                <button type="button" onclick="storeCustomerForm()"
                                        ...
                                        <table class="table align-middle table-nowrap" id="customerTable">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th class="sort" data-sort="total">اجمالي المبلغ المنفق</th>
                                            ...
                                            <tbody class="list form-check-all">
                                                @forelse ($customers as $customer)
                                                    <tr>
                                                        ...
                                                        <td class="total">{{ $customer->phone }}</td>
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                <div class="edit">
                                                                    <button class="btn btn-sm btn-success edit-item-btn"
                                                                        data-bs-toggle="modal" data-bs-target="#showModal"
                                                                        onclick="getCustomer({{ $customer->id }})">تعديل</button>
                                                                </div>
                                                                <div class="remove">
                                                                    <button class="btn btn-sm btn-danger remove-item-btn"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#deleteRecordModal"
                                                                        onclick="$('#deleteRecord').attr('data-id', '{{ $customer->id }}')">حذف</button>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                ...
                <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form class="tablelist-form" autocomplete="off" id="customerForm">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="customerName" class="form-control"
                                            placeholder="ادخل اسم العميل" required name="name" />
                                    </div>

                                    <div class="mb-3">
                                        <label for="customerPhone " class="form-label">رقم العميل</label>
                                        <input type="text" id="customerPhone" class="form-control"
                                            placeholder="ادخل رقم العميل" required name="phone" />
                                    </div>
...
@section('js')
    <script>
        ...
        function getCustomer(id) {
            ...
            $.ajax({
                url: "{{ route('panel.customers.getCustomer', '') }}/" + id,
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    $("#customerName").val(response.name);
                    $("#customerPhone").val(response.phone);
                    $("#customerForm").attr("action", "{{ route('panel.customers.update', '') }}/" + id);
        ...
        function storeCustomerForm() {
            $('#customerForm').attr('method', 'POST');
            $('#customerForm').attr('action', '{{ route('panel.customers.store') }}')
        ...
        function deleteItem() {
            ...
            $.ajax({
                url: "{{ route('panel.customers.destroy', '') }}/" + id,
                type: 'DELETE',
                dataType: 'json',
                headers: {
